...
./target/release/aleph-node bootstrap-chain --millisecs-per-block 1000 --session-period 10 --base-path "$BASE_PATH" --chain-id dev --account-ids "$validator_ids_string" > "$BASE_PATH/chainspec.json"
